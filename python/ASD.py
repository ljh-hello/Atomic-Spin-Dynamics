...
def main():
    ...
    ax.set_xlim(-2, 5)
    ax.set_ylim(-2, 5)
    ani = animation.FuncAnimation(fig, update_quiver, fargs=(Q, s_xyz),  frames=np.arange(0,step,500), interval=50,repeat_delay=500, blit=True)
    # fig.tight_layout()
    # plt.show()
